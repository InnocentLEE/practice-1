define(['/Modules/Config/conwin.main.js'], function () {
    require(['jquery', 'popdialog', 'tipdialog', 'toast', 'helper', 'common', 'formcontrol', 'prevNextpage', 'tableheadfix', 'system', 'selectcity', 'filelist', 'fileupload', 'selectCity2', 'metronic', 'customtable', 'bootstrap-datepicker.zh-CN', 'bootstrap-datetimepicker.zh-CN'],
        ...
        //模块初始化
            ...
            //取单个代理商信息接口
            function getShiJiJianGuanBuMenXinXi(id, callback) {
                helper.Ajax("008808800022", id, function (resultdata) {
            ...
            function updateData() {
                ...
                getShiJiJianGuanBuMenXinXi(id, function (serviceData) {
            ...
            function save() {
                ...
                //调用新增接口
                helper.Ajax("008808800023", jsonData1, function (data) {
                    if ($.type(data) == "string") {
