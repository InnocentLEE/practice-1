(function (root, config) {
...
})(this,
    {
        ...
        ServiceCodeTable: [
            ...
            // 修改市级监管部门
            { code: "008808800023", ver: '1.0', url: "http://localhost:8080/008808800013" },
            // 批量删除市级监管部门
            { code: "008808800024", ver: '1.0', url: "http://localhost:8080/008808800014" },

            // 新增客运站
            { code: "008808800030", ver: '1.0', url: "http://localhost:8080/008808800020" },
            // 获取客运站列表
            { code: "008808800031", ver: '1.0', url: "http://localhost:8080/008808800021" },
            // 获取客运站详情
            { code: "008808800032", ver: '1.0', url: "http://localhost:8080/008808800022" },
            // 修改客运站
            { code: "008808800033", ver: '1.0', url: "http://localhost:8080/008808800013" },
            // 批量删除客运站
            { code: "008808800034", ver: '1.0', url: "http://localhost:8080/008808800014" },
