    ...
    require(['jquery', 'popdialog', 'tipdialog', 'toast', 'helper', 'common', 'formcontrol', 'prevNextpage', 'tableheadfix', 'system', 'selectcity', 'filelist', 'fileupload', 'metronic', 'customtable', 'bootstrap-datepicker.zh-CN', 'bootstrap-datetimepicker.zh-CN'],
        function ($, popdialog, tipdialog, toast, helper, common, formcontrol, prevNextpage, tableheadfix, system, selectcity, filelist, fileupload) {
            ...
            function getQiYeXinXi(id, callback) {
                //调用获取单条信息接口
                helper.Ajax("003300300023", id, function (resultdata) {
            ...
            function fillFormData(resource) {
                ...
                $("#jigoumingcheng").html($("#YeHuMingCheng").val());
                if ($("#YouXiaoZhuangTai").val() == 1) {
                    $("#zhuangtai").html("正常营业");
                    $("#YouXiaoZhuangTais").html("正常营业");

                }
                else {
                    $("#zhuangtai").html("合约到期");
                    $("#YouXiaoZhuangTais").html("合约到期");
                ...
                if (jjlx == "4") jjlx = "中外合资";
                if (jjlx == "5") jjlx = "其他";
                $("#JingJiLeiXings").html(jjlx);

                var jjlx = $("#JingYingXuKeZhengYouXiaoZhuangTai").val();
                if (jjlx == "1") jjlx = "有效";
                if (jjlx == "2") jjlx = "过期";
                $("#JingYingXuKeZhengYouXiaoZhuangTais").html(jjlx);

                var jjlx = $("#YouXiaoZhuangTai").val();
                if (jjlx == "1") jjlx = "有效";
                if (jjlx == "2") jjlx = "无效";


                var jjlx = $("#BeiAnZhuangTai").val();
                if (jjlx == "1") jjlx = "已备案";
                if (jjlx == "2") jjlx = "未备案";
                $("#BeiAnZhuangTais").html(jjlx);
