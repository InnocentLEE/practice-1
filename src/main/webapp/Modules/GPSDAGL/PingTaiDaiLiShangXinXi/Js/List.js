    ...
    function ($, popdialog, tipdialog, toast, helper, common, tableheadfix, system,userinfo) {
        var initPage = function () {
            ...
            $('#btnDel').on('click', function (e) {
                ...
                tipdialog.confirm("确定要删除选中的记录？", function (r) {
                    if (r) {
                        //TODO:调作废接口
                        helper.Ajax("003300300006", ids, function (data) {
                            if ($.type(data) == "string") {
            ...
            $('#btnCancel').on('click', function (e) {
                ...
                tipdialog.confirm("确定要停用选中的记录？", function (r) {
                    if (r) {
                        //TODO:调作废接口
                        helper.Ajax("003300300007", ids, function (data) {
                            if ($.type(data) == "string") {
                                data = helper.StrToJson(data);
                            }
                            if (data.publicresponse.statuscode == 0) {
            ...
            $('#btnUse').on('click', function (e) {
                ...
                tipdialog.confirm("确定要启用选中的记录？", function (r) {
                    if (r) {
                        //TODO:调作废接口
                        helper.Ajax("003300300008", ids, function (data) {
                            if ($.type(data) == "string") {
                                data = helper.StrToJson(data);
                            }
                            if (data.publicresponse.statuscode == 0) {
        ...
        function initlizableTable() {
            $("#tb_Template").CustomTable({
                ajax: helper.AjaxData("003300300001",///"00020003"为接口服务地址，需要在/Config/conwin.system.js中配置
             function (data) {
