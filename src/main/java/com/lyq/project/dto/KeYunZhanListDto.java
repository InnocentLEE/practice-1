...
public class KeYunZhanListDto {
    ...
    public KeYunZhanListDto() {
    }

    public KeYunZhanListDto(String id, String unitName, String province, String city, String popedom, int businessType, String contactMen, Date inNetDate) {
        Id = id;
        UnitName = unitName;
        Province = province;
        City = city;
