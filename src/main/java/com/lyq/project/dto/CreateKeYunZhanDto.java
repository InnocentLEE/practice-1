...
public class CreateKeYunZhanDto {
    ...
    public CreateKeYunZhanDto(String id, String unitName, String province, String city, Integer businessType, String permitWord, String permitNum, String permitDate, String address, String name, String idCard, String tel, String phone, String email, String QQ, String memo) {
        Id = id;
        UnitName = unitName;
        Province = province;
        City = city;
