...
public class KeYunQiYeDetail {
    ...
    public KeYunQiYeDetail() {
    }

    public KeYunQiYeDetail(String id, String unitName, String province, String city, String popedom, int businessType, String businessTypeValue, Date inNetDate, String address, String permitWord, String permitNum, Date permitDate, String permitDateValue, String name, String idCard, String tel, String phone, String email, String QQ, String memo) {
        Id = id;
        UnitName = unitName;
        Province = province;
        City = city;
